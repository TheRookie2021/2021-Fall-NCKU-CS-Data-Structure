/*
[read] accept a tree represented as a parenthesized list as input and create 
the generalized list representation of the tree.
...
void backtoformula(Tree tree){
    ...
    //cur=cur->down;
    string[0]='(';
    for(int i=1;top>-1;cur=cur->down){
